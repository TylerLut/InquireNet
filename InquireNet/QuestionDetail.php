...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['newAnswer']) && $questionId) {
    ...
    if (!empty($newAnswer)) { 
        ...
        $insertStmt = $conn->prepare("INSERT INTO Answers (question_id, user_id, answer_text) VALUES (?, ?, ?)");
        $insertStmt->bind_param("iis", $questionId, $userId, $newAnswer);
    ...
    <header>
        <div class="banner">
            ...
            <div class="user-header-info">
                ...
                <button onclick="location.href='MainPage(BeforeLogin).php'">Logout</button>
            </div>
        </div>
    </header>
